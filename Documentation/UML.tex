...
\begin{umlpackage}[x=+0, y=-2]{Settings}
    ...
    {Settings S}
    {
        ...
        \umlstatic{+Locations: ObservableCollection<Location.Location>}   \\
    }
    {
        \umlstatic{+ObservableCollection\_Locations\_CollectionChanged(...)}
    }
...
\begin{umlpackage}[x=+0, y=-40]{Serializable}
    ...
    \umlcompo[geometry=|-|]{Location S}{Location::SourceType}
\end{umlpackage}
...
\begin{umlpackage}[x=-20, y=-32]{FileSystem}
    ...
    {
        +Name: String \\
        +Directories: IEnumerable<IDirectory> \\
...
\umlaggreg[geometry=|-]{Settings S}{Location L}
\umlaggreg[geometry=|-|]{Settings S}{Notebook N}
