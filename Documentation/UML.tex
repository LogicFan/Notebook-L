...
\begin{umlpackage}[x=-20, y=-36]{Account}
    \umlclass[x=+0, y=+0, name=AAcount]
    {Account A}
    {
        ...
        +Account(data: Serializable.Account)
    }
\end{umlpackage}
...
\begin{umlpackage}[x=+0, y=-40]{Serializable}
    ...
    \umlaggreg[geometry=|-|]{Account::SourceType}{Account}
\end{umlpackage}
...
\umlaggreg[geometry=|-]{Settings}{Account A}
\umlaggreg[geometry=|-|]{Settings}{Notebook N}

\umlcompo{IFileSystem}{Account A}
\umlcompo{Account A}{Account S}
